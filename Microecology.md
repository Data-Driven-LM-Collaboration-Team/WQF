...
- [ ] 比较三个菌群模块在正常组与肥胖组之间的差异  
  ...
  使用rclr值，求每个模块的均值后进行z-score标准化后比较。 
     
统计检验结果： 

| Module | p-value   | Cohen_d   | Rank_Biserial_r | Mean_Diff  | p-adj    | 
|--------|-----------|-----------|----------------|------------|----------| 
| C1A    | 0.360453  | 0.045575  | 0.033907       | 0.046020   | 0.360453 | 
| C1B    | 0.056715  | -0.123071 | -0.070647      | -0.087788  | 0.170144 | 
| C1C    | 0.199103  | -0.054919 | -0.047610      | -0.033535  | 0.298654 | 

<img width="737" height="537" alt="image" src="https://github.com/user-attachments/assets/12f060f3-c902-435a-9f9a-4522a3c97694" /> 
